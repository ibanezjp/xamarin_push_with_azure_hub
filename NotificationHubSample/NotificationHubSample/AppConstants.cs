namespace NotificationHubSample
{
    public static class AppConstants
    {
        ...
        /// </summary>
        public static string NotificationHubName { get; set; } = "chat_test_1";
        ...
        /// </summary>
        public static string ListenConnectionString { get; set; } = "Endpoint=sb://basechatapp.servicebus.windows.net/;SharedAccessKeyName=DefaultListenSharedAccessSignature;SharedAccessKey=zUisJwHCEoTIdGvJzmnkLuCyDLNdA6s7MJJO9zlCf2M=";
